...
//   description : "Create personalized learning roadmaps with our AI-powered roadmap generator, tailored to your goals and interests.",
//   Icon : SquarePen,
...
//     description:
//       "Generate customized quizzes on any topic with our AI quiz generator, perfect for learning and assessment.",
//     Icon: Hash,
...
export const AiToolsData = [
  {
    title: "AI Roadmap",
    description:
      "Generate a structured learning roadmap tailored to your goals, skills, and career path using AI.",
    Icon: Sparkles,
    bg: { from: "#3588F2", to: "#0BB0D7" },
    path: "/ai/roadmap-generator",
  },
  {
    title: "AI Quiz",
    description:
      "Create customized quizzes instantly on any topic to test and improve your knowledge.",
    Icon: Hash,
    bg: { from: "#B153EA", to: "#E549A3" },
    path: "/ai/tech-quiz",
  },
  ...
  // 🎯 Interview Section
  {
    ...
    description:
      "Practice real-time voice interviews with AI and get instant feedback on your answers.",
    Icon: Mic,
    bg: { from: "#FF7A18", to: "#FFB347" },
    path: "/ai/voice-interview",
  },
  {
    title: "AI Chat Interview",
    description:
      "Simulate technical and HR interviews through chat and improve your confidence.",
    Icon: Users,
  ...
  },
  {
    ...
    description:
      "Analyze and optimize your resume with AI suggestions to increase your chances of selection.",
    Icon: FileText,
    bg: { from: "#12B7AC", to: "#08B6CE" },
    path: "/ai/review-resume",
  },
  ...
  // ✍️ Content Section
  {
    ...
    description:
      "Generate high-quality, SEO-friendly articles on any topic in seconds.",
    Icon: SquarePen,
    bg: { from: "#3588F2", to: "#0BB0D7" },
    path: "/ai/write-article",
  },
  {
    ...
    description:
      "Create catchy and engaging blog titles to boost your content reach.",
    Icon: Hash,
    bg: { from: "#B153EA", to: "#E549A3" },
    path: "/ai/blog-titles",
  },
  ...
  // 🎨 Tools Section
  {
    ...
    description:
      "Create stunning AI-generated images from text prompts in seconds.",
    Icon: Image,
    bg: { from: "#20C363", to: "#11B97E" },
    path: "/ai/generate-images",
  },
  {
    title: "AI Remove BGV",
    description:
      "Remove image backgrounds instantly with high precision using AI.",
    Icon: Eraser,
    bg: { from: "#F76C1C", to: "#F04A3C" },
    path: "/ai/remove-background",
  },
  {
    ...
    description:
      "Erase unwanted objects from images seamlessly with AI-powered editing.",
    Icon: Scissors,
    bg: { from: "#5C6AF1", to: "#427DF5" },
    path: "/ai/remove-object",
  },
