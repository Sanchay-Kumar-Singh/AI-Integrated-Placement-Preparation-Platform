  ...
  return (
    <>
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 font-sans text-white  ">
        {/* TOP HEADING */}
        <div  className="w-full max-w-md bg-slate-950 rounded-3xl shadow-2xl border border-slate-700 overflow-hidden">

          {/* Header Section */}
          <div  className="p-6 border-b border-slate-700 flex justify-between items-center bg-slate-950">
            <div >
              <h2 className="text-lg md:text-[30px] font-bold text-white">AI voice Interview</h2>
              <p style={{color:"#0bd95a"}} className="text-xs md:text-[15px]">{topic || "Setup Phase"}</p>
            </div>
            {question && !completed && (
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col items-center mb-8">
              <div className="relative">
                ...
                <div className={`w-24 h-24 rounded-full flex items-center justify-center text-5xl border-2 transition-all duration-300 ${speaking ? "bg-purple-600 border-purple-400 shadow-[0_0_20px_rgba(168,85,247,0.4)]" : "bg-slate-700 border-slate-600"
                  }`}>
                  {completed ? "🏁" : "🤖"}
                </div>
              </div>
            ...
            {question && !completed && (
              <div className="space-y-6 text-center animate-in slide-in-from-bottom-4">
                ...
                <button
                  ...
                  className={`w-20 h-20 rounded-full flex items-center justify-center transition-all ${listening
