...
//         speak("Interview completed. Here is your result.");
//         setCompleted(true);
//         setListening(false);
//         return;
//       }
...
//       <h1 className="text-2xl font-bold mb-6">🤖 AI Voice Interview</h1>

//       {/* 🤖 AI AVATAR */}
//       <div className="flex justify-center mb-6">
//         <div
//           className={`w-24 h-24 rounded-full flex items-center justify-center text-4xl bg-purple-100 ${
